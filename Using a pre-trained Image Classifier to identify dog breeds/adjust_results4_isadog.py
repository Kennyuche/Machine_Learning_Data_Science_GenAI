...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    for key in results_dic:
        ...
        # Is classifier predicting dog?
        classifier_labels = [cl.strip() for cl in classifier_label.split(",")]
        is_classifier_dog = 1 if any(cl in dognames_dic for cl in classifier_labels) else 0
